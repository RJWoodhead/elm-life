...
var _user$project$Main$exportHeader = '!Name: [Fill In]\n!Author: [Fill In]\n!\n!Computed by Elm-Life\n';
var _user$project$Main$builtinBoards = {
	ctor: '::',
...
var _user$project$Main$patternGet = F2(
	function (prefix, pattern) {
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$filter,
					_elm_lang$core$String$startsWith(prefix),
					_elm_lang$core$String$lines(pattern))));
	});
var _user$project$Main$patternDescription = function (line) {
	return A2(_elm_lang$core$String$startsWith, '!', line) && ((!A2(_elm_lang$core$String$startsWith, '!Name:', line)) && ((!A2(_elm_lang$core$String$startsWith, '!Author:', line)) && (!A2(_elm_lang$core$String$startsWith, '!http', line))));
};
var _user$project$Main$patternInfo = function (pattern) {
	var fixed = A2(
		_elm_lang$core$String$join,
		'!http://www.',
		A2(_elm_lang$core$String$split, '!www.', pattern));
	var name = A2(_user$project$Main$patternGet, '!Name:', fixed);
	var author = A2(_user$project$Main$patternGet, '!Author:', fixed);
	var url = A2(_user$project$Main$patternGet, '!http', fixed);
	var description = A2(
		_elm_lang$core$String$join,
		' ',
		A2(
			...
			A2(
				_elm_lang$core$List$filter,
				_user$project$Main$patternDescription,
				_elm_lang$core$String$lines(fixed))));
	return {ctor: '_Tuple4', _0: name, _1: author, _2: description, _3: url};
};
var _user$project$Main$offsetPosition = A3(
	...
	A2(_elm_lang$core$Json_Decode$field, 'pageX', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'pageY', _elm_lang$core$Json_Decode$int));
var _user$project$Main$mouseEvent = F2(
	function (event, messager) {
		var options = {preventDefault: true, stopPropagation: true};
		return A3(
			_elm_lang$virtual_dom$VirtualDom$onWithOptions,
			event,
			options,
			A2(_elm_lang$core$Json_Decode$map, messager, _user$project$Main$offsetPosition));
	});
var _user$project$Main$mouseClick = _user$project$Main$mouseEvent('click');
var _user$project$Main_ops = _user$project$Main_ops || {};
_user$project$Main_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Main$selectOption = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$option,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$selected(_p1._2),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Main$select = F2(
	function (msg, items) {
		return A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Main$selectOption, items));
	});
var _user$project$Main$link = F2(
	function (url, label) {
		return A2(_elm_lang$core$String$startsWith, 'mailto:', url) ? A2(
...
var _user$project$Main$slider = F5(
	function (msg, cname, minv, maxv, value) {
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$name(cname),
					_1: {
						ctor: '::',
...
var _user$project$Main$fixRLEHeaders = function (hdr) {
	var kill_ = F2(
		function (prefix, line) {
			return A2(
				_elm_lang$core$String$startsWith,
				prefix,
				_elm_lang$core$String$toUpper(line)) ? '' : line;
		});
	var remap_ = F3(
		function (prefix, repl, line) {
			return A2(
				_elm_lang$core$String$startsWith,
				prefix,
				_elm_lang$core$String$toUpper(line)) ? A2(
				F2(
					function (x, y) {
...
var _user$project$Main$rleToCell = F3(
	function (acc, mult, rle) {
		rleToCell:
		while (true) {
			var _p2 = rle;
			if (_p2.ctor === '::') {
				...
				switch (_p3.valueOf()) {
					case 'b':
						var _v3 = A2(
							...
							A2(
								...
								A2(_elm_lang$core$Basics$max, mult, 1),
								'.')),
							_v4 = 0,
							_v5 = _p5;
						acc = _v3;
					...
					case '$':
						...
						continue rleToCell;
					default:
						if (_elm_lang$core$Char$isDigit(_p4)) {
							var digit = A2(
...
var _user$project$Main$shiftList = F3(
	function (blank, rot, list) {
		return (_elm_lang$core$Native_Utils.cmp(rot, 0) > -1) ? A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$drop, rot, list),
			A2(_elm_lang$core$List$repeat, rot, blank)) : A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$repeat, 0 - rot, blank),
			A2(
				_elm_lang$core$List$take,
				_elm_lang$core$List$length(list) + rot,
				list));
	});
var _user$project$Main$rotateList = F2(
	function (rot, list) {
		var r = A2(
			_elm_lang$core$Basics_ops['%'],
			rot,
...
var _user$project$Main$setCell = F4(
	function (board, row, col, newcell) {
		var setColumn_ = F2(
			function (colnum, cell) {
				return (!_elm_lang$core$Native_Utils.eq(colnum, col)) ? cell : newcell;
			});
		var setRow_ = F2(
			function (rownum, therow) {
				return (!_elm_lang$core$Native_Utils.eq(rownum, row)) ? therow : A2(_elm_lang$core$List$indexedMap, setColumn_, therow);
			});
		return A2(_elm_lang$core$List$indexedMap, setRow_, board);
	});
var _user$project$Main$minBoardSize = 32;
var _user$project$Main$minCellSize = 8;
var _user$project$Main$boardDim = 4096;
var _user$project$Main$maxBoardSize = (_user$project$Main$boardDim / _user$project$Main$minCellSize) | 0;
var _user$project$Main$initialLocation = _elm_lang$core$Native_Platform.outgoingPort(
	'initialLocation',
	function (v) {
		return null;
	});
var _user$project$Main$boardLocation = _elm_lang$core$Native_Platform.incomingPort(
	'boardLocation',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (top) {
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {board: a, headers: b, paintRow: c, paintCol: d, paintColor: e, painting: f, boardLocation: g, wrap: h, running: i, speed: j, mode: k, inputMode: l, importedBoard: m, seed: n};
													};
												};
											};
										};
...
var _user$project$Main$Flags = F2(
	function (a, b) {
		return {hasTouch: a, randomSeed: b};
	});
var _user$project$Main$ObjectLocation = F4(
	function (a, b, c, d) {
		return {top: a, left: b, width: c, height: d};
	});
var _user$project$Main$Dead = {ctor: 'Dead'};
var _user$project$Main$getCell = F3(
	function (board, row, col) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Main$Dead,
...
var _user$project$Main$resizeBoard = F2(
	function (tosize, board) {
		var deadrow = A2(_elm_lang$core$List$repeat, tosize, _user$project$Main$Dead);
		var w = function () {
			var _p6 = _elm_lang$core$List$head(board);
			if (_p6.ctor === 'Just') {
				return _elm_lang$core$List$length(_p6._0);
			} else {
				return 0;
			}
		}();
		...
		var padRow_ = function (row) {
			return _elm_lang$core$List$concat(
				{
					ctor: '::',
					_0: A2(_elm_lang$core$List$repeat, l, _user$project$Main$Dead),
					_1: {
						ctor: '::',
						_0: row,
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$core$List$repeat, r, _user$project$Main$Dead),
							_1: {ctor: '[]'}
						}
					}
				});
		};
		var trimRow_ = function (row) {
			return A2(
				_elm_lang$core$List$take,
				tosize,
				A2(_elm_lang$core$List$drop, l, row));
		};
		...
		var result = (_elm_lang$core$Native_Utils.cmp(tosize, h) > 0) ? _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$List$repeat, t, deadrow),
				_1: {
					ctor: '::',
					_0: rewidthed,
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$List$repeat, b, deadrow),
						_1: {ctor: '[]'}
					}
				}
			}) : ((_elm_lang$core$Native_Utils.cmp(tosize, h) < 0) ? A2(
			_elm_lang$core$List$take,
			tosize,
			A2(_elm_lang$core$List$drop, t, rewidthed)) : rewidthed);
		return result;
	});
var _user$project$Main$Alive = {ctor: 'Alive'};
var _user$project$Main$countCells = F3(
	function (vshift, hshift, board) {
		var cellSum_ = F3(
			function (cell, adj1, adj2) {
				return (cell + adj1) + adj2;
			});
		var rowSum_ = F3(
			function (row, adj1, adj2) {
				return A4(_elm_lang$core$List$map3, cellSum_, row, adj1, adj2);
			});
		var toRowCount_ = function (row) {
			return A2(
				_elm_lang$core$List$map,
				function (cell) {
					return _elm_lang$core$Native_Utils.eq(cell, _user$project$Main$Alive) ? 1 : 0;
				},
				row);
		};
		var boardcount = A2(_elm_lang$core$List$map, toRowCount_, board);
		var rl = A2(
			_elm_lang$core$List$map,
			hshift(1),
			boardcount);
		var rr = A2(
			...
			hshift(-1),
			boardcount);
		var rowNeighbors = A4(_elm_lang$core$List$map3, rowSum_, boardcount, rl, rr);
		var ru = A2(vshift, 1, rowNeighbors);
		var rd = A2(vshift, -1, rowNeighbors);
		var result = A4(_elm_lang$core$List$map3, rowSum_, rowNeighbors, rd, ru);
		return result;
	});
var _user$project$Main$evolveBoard = F2(
	function (board, neighbors) {
		var evolveCell_ = F2(
			function (cell, neighbors) {
				return (_elm_lang$core$Native_Utils.eq(neighbors, 3) || (_elm_lang$core$Native_Utils.eq(cell, _user$project$Main$Alive) && _elm_lang$core$Native_Utils.eq(neighbors, 4))) ? _user$project$Main$Alive : _user$project$Main$Dead;
			});
		var evolveRow_ = F2(
			function (row, neighbors) {
				return A3(_elm_lang$core$List$map2, evolveCell_, row, neighbors);
			});
		return A3(_elm_lang$core$List$map2, evolveRow_, board, neighbors);
	});
var _user$project$Main$generation = function (model) {
	var mbs = _elm_lang$core$List$length(model.board);
	var hasEdgeCell_ = function (board) {
		var top = function () {
			var _p9 = _elm_lang$core$List$head(board);
			if (_p9.ctor === 'Just') {
				return A2(_elm_lang$core$List$member, _user$project$Main$Alive, _p9._0);
			} else {
				return false;
			}
		}();
		...
		var bottom = function () {
			var _p10 = _elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, bsm1, board));
			if (_p10.ctor === 'Just') {
				return A2(_elm_lang$core$List$member, _user$project$Main$Alive, _p10._0);
			} else {
				return false;
			}
		}();
			...
			function (row, carry) {
				var right = function () {
					var _p11 = _elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, bsm1, row));
					if (_p11.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p11._0, _user$project$Main$Alive);
					} else {
						return false;
					}
				}();
				var left = function () {
					var _p12 = _elm_lang$core$List$head(row);
					if (_p12.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p12._0, _user$project$Main$Alive);
					} else {
						return false;
					}
				}();
		...
		var sides = A3(_elm_lang$core$List$foldl, rowEdgeCell_, false, board);
		return top || (bottom || sides);
	};
	var startBoard = ((!model.wrap) && ((_elm_lang$core$Native_Utils.cmp(mbs, _user$project$Main$maxBoardSize) < 0) && hasEdgeCell_(model.board))) ? A2(_user$project$Main$resizeBoard, mbs + 2, model.board) : model.board;
	var _p13 = model.wrap ? {ctor: '_Tuple2', _0: _user$project$Main$rotateList, _1: _user$project$Main$rotateList} : {
		ctor: '_Tuple2',
		_0: _user$project$Main$shiftList(
			A2(
				_elm_lang$core$List$repeat,
				_elm_lang$core$List$length(startBoard),
				0)),
		_1: _user$project$Main$shiftList(0)
	};
	var vshift = _p13._0;
	var hshift = _p13._1;
	var neighbors = A3(_user$project$Main$countCells, vshift, hshift, startBoard);
	var newBoard = A2(_user$project$Main$evolveBoard, startBoard, neighbors);
	var result = _elm_lang$core$Native_Utils.update(
		model,
		{board: newBoard});
	return result;
};
var _user$project$Main$makeSoup = F2(
	function (seed, board) {
		var dim = _elm_lang$core$List$length(board);
		var soupCell = A2(
			_elm_lang$core$Random$map,
			function (i) {
				return _elm_lang$core$Native_Utils.eq(i, 0) ? _user$project$Main$Alive : _user$project$Main$Dead;
			},
			A2(_elm_lang$core$Random$int, 0, 8));
		var soupRow = A2(_elm_lang$core$Random$list, dim, soupCell);
		var soupBoard = A2(_elm_lang$core$Random$list, dim, soupRow);
		var _p14 = A2(_elm_lang$core$Random$step, soupBoard, seed);
		var newboard = _p14._0;
		var newseed = _p14._1;
		return {ctor: '_Tuple2', _0: newseed, _1: newboard};
	});
var _user$project$Main$decodeCELL = function (template) {
	var strToCell_ = function ($char) {
		return (_elm_lang$core$Native_Utils.eq(
			$char,
			_elm_lang$core$Native_Utils.chr('.')) || _elm_lang$core$Native_Utils.eq(
			$char,
			_elm_lang$core$Native_Utils.chr(' '))) ? _user$project$Main$Dead : _user$project$Main$Alive;
	};
	var rowToCell_ = function (row) {
		return A2(
			_elm_lang$core$List$map,
			strToCell_,
	...
	var _p15 = A2(
		...
		_elm_lang$core$String$lines(
			_elm_lang$core$String$trim(template)));
	var comments = _p15._0;
	var boardcells = _p15._1;
	var headers = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$String$dropLeft(1),
		comments);
	var mw = A2(
		...
		_elm_lang$core$List$maximum(
			A2(_elm_lang$core$List$map, _elm_lang$core$String$length, boardcells)));
	var padshort = A2(
		_elm_lang$core$List$map,
		A2(
		...
		boardcells);
	var board = A2(_elm_lang$core$List$map, rowToCell_, padshort);
	return {ctor: '_Tuple2', _0: headers, _1: board};
};
var _user$project$Main$decodeRLE = function (template) {
	var _p16 = A2(
		_elm_lang$core$List$partition,
		_elm_lang$core$String$startsWith('#'),
		A2(
			...
			A2(
				...
				_elm_lang$core$String$lines(template))));
	var comments = _p16._0;
	var pattern = _p16._1;
	var headers = A2(
		_elm_lang$core$List$filter,
		function (s) {
		...
		A2(_elm_lang$core$List$map, _user$project$Main$fixRLEHeaders, comments));
	var board = function () {
		var _p17 = pattern;
		if (_p17.ctor === '::') {
			var xy = A2(
						...
						if (_p18._1.ctor === '::') {
							if (_p18._0 === 0) {
								...
								if (_p18._1._0 === 0) {
									...
									var _p19 = _user$project$Main$decodeCELL(
										A3(
											_user$project$Main$rleToCell,
											'',
											0,
												...
												A2(
													...
													_elm_lang$core$List$head(
														A2(
															...
															'!',
															_elm_lang$core$String$concat(_p17._1)))))));
									var converted = _p19._1;
									return converted;
								}
							}
						} else {
...
var _user$project$Main$loadBoard = function (pattern) {
	var _p20 = _user$project$Main$decodeRLE(pattern);
	var h1 = _p20._0;
	var c1 = _p20._1;
	var _p21 = _elm_lang$core$Native_Utils.eq(
		c1,
		{ctor: '[]'}) ? _user$project$Main$decodeCELL(pattern) : {ctor: '_Tuple2', _0: h1, _1: c1};
	var headers = _p21._0;
	var cells = _p21._1;
	var w = _elm_lang$core$List$length(
		A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			_elm_lang$core$List$head(cells)));
	var h = _elm_lang$core$List$length(cells);
	var boardsize = A2(
		_elm_lang$core$Basics$max,
		_user$project$Main$minBoardSize,
		8 + A2(_elm_lang$core$Basics$max, w, h));
	var board = A2(_user$project$Main$resizeBoard, boardsize, cells);
	return {ctor: '_Tuple2', _0: headers, _1: board};
};
var _user$project$Main$trimBoard = function (board) {
	var firstColumn_ = function (board) {
		return A2(
			_elm_lang$core$List$map,
			function (r) {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$Main$Dead,
					_elm_lang$core$List$head(r));
			},
			board);
	};
	var trimCols_ = function (board) {
		trimCols_:
		while (true) {
			var fc = firstColumn_(board);
			if (_elm_lang$core$List$isEmpty(fc) || A2(
				_elm_lang$core$List$member,
				_user$project$Main$Alive,
				firstColumn_(board))) {
				return board;
			} else {
				var _v25 = A2(
	...
	var trimRows_ = function (board) {
		trimRows_:
		while (true) {
			var _p22 = board;
			if (_p22.ctor === '::') {
				if (A2(_elm_lang$core$List$member, _user$project$Main$Alive, _p22._0)) {
					return board;
				} else {
					var _v27 = _p22._1;
					board = _v27;
...
var _user$project$Main$boardToStr = function (board) {
	var dotTrim_ = function (s) {
		dotTrim_:
		while (true) {
			if (A2(_elm_lang$core$String$endsWith, '.', s)) {
				var _v28 = A2(_elm_lang$core$String$dropRight, 1, s);
				s = _v28;
				continue dotTrim_;
			} else {
				return s;
	...
	var rowToStr_ = function (row) {
		return dotTrim_(
			_elm_lang$core$String$fromList(
				A2(
					_elm_lang$core$List$map,
					function (c) {
						return _elm_lang$core$Native_Utils.eq(c, _user$project$Main$Alive) ? _elm_lang$core$Native_Utils.chr('O') : _elm_lang$core$Native_Utils.chr('.');
					},
					row)));
	};
	return A2(
		_elm_lang$core$String$join,
		'\n',
		A2(_elm_lang$core$List$map, rowToStr_, board));
};
var _user$project$Main$cellSvg = F4(
	function (csize, ypos, xpos, cell) {
		return _elm_lang$core$Native_Utils.eq(cell, _user$project$Main$Alive) ? _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$svg$Svg$rect,
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(csize - 4)),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$x(
								_elm_lang$core$Basics$toString(xpos * csize)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString(ypos * csize)),
								_1: {
									ctor: '::',
...
var _user$project$Main$rowSvg = F3(
	function (csize, row, cells) {
		return A2(
			_elm_lang$core$List$filterMap,
			_elm_lang$core$Basics$identity,
			A2(
				_elm_lang$core$List$indexedMap,
				A2(_user$project$Main$cellSvg, csize, row),
				cells));
	});
var _user$project$Main$boardSvg = F2(
	function (csize, board) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$indexedMap,
				_user$project$Main$rowSvg(csize),
				board));
	});
var _user$project$Main$Patterns = {ctor: 'Patterns'};
...
var _user$project$Main$UsingMouse = {ctor: 'UsingMouse'};
var _user$project$Main$init = function (flags) {
	var inputMode = flags.hasTouch ? _user$project$Main$UsingTouch : _user$project$Main$UsingMouse;
	var pattern = _elm_lang$core$List$head(_user$project$Main$builtinBoards);
	var _p23 = _user$project$Main$loadBoard(
		function () {
			var _p24 = pattern;
			if (_p24.ctor === 'Just') {
				return _p24._0;
	...
	var cellsize = A2(
		_elm_lang$core$Basics$max,
		_user$project$Main$minCellSize,
		(_user$project$Main$boardDim / _elm_lang$core$List$length(board)) | 0);
	return {
		ctor: '_Tuple2',
		_0: {
			board: board,
			...
			paintRow: 0,
			paintCol: 0,
			paintColor: _user$project$Main$Dead,
			painting: false,
			boardLocation: A4(_user$project$Main$ObjectLocation, 0, 0, 0, 0),
			wrap: false,
			running: false,
			speed: 0,
		...
		_1: _user$project$Main$initialLocation(
			{ctor: '_Tuple0'})
	};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p25.ctor) {
			case 'ToggleRun':
				var running = (!model.running) && (_elm_lang$core$Native_Utils.cmp(model.speed, 0) > 0);
				var result = _user$project$Main$generation(
					_elm_lang$core$Native_Utils.update(
						model,
						{running: running, painting: false}));
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Tick':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$generation(model),
			...
			case 'SetMode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{mode: _p25._0, running: false, painting: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetInputMode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{inputMode: _p25._0, running: false, painting: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MouseDown':
				var _p26 = A2(_user$project$Main$transformCoordinates, model, _p25._0);
				var row = _p26._0;
				var col = _p26._1;
				var valid = _p26._2;
				var result = function () {
					if (valid) {
						var painting = _elm_lang$core$Native_Utils.eq(model.inputMode, _user$project$Main$UsingMouse);
						var paintColor = _elm_lang$core$Native_Utils.eq(
							A3(_user$project$Main$getCell, model.board, row, col),
							_user$project$Main$Alive) ? _user$project$Main$Dead : _user$project$Main$Alive;
						var newboard = A4(_user$project$Main$setCell, model.board, row, col, paintColor);
						return _elm_lang$core$Native_Utils.update(
							model,
							{board: newboard, paintRow: row, paintCol: col, paintColor: paintColor, painting: painting});
					} else {
						return model;
					}
				}();
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'MouseMove':
				var _p27 = A2(_user$project$Main$transformCoordinates, model, _p25._0);
				var row = _p27._0;
				var col = _p27._1;
				var valid = _p27._2;
				var result = function () {
					if (valid) {
						var newboard = A4(_user$project$Main$setCell, model.board, row, col, model.paintColor);
						return _elm_lang$core$Native_Utils.update(
							model,
							{board: newboard});
					} else {
			...
			case 'Shift':
				...
				var shifted = function () {
					...
					switch (_p28.ctor) {
						case 'Up':
							return model.wrap ? A2(_user$project$Main$rotateList, 1, model.board) : A3(_user$project$Main$shiftList, deadrow, 1, model.board);
						case 'Down':
							return model.wrap ? A2(_user$project$Main$rotateList, -1, model.board) : A3(_user$project$Main$shiftList, deadrow, -1, model.board);
						case 'Left':
							return model.wrap ? A2(
								_elm_lang$core$List$map,
								_user$project$Main$rotateList(1),
								model.board) : A2(
								_elm_lang$core$List$map,
								A2(_user$project$Main$shiftList, _user$project$Main$Dead, 1),
								model.board);
						case 'Right':
							return model.wrap ? A2(
								_elm_lang$core$List$map,
						...
						default:
							return A2(
								_elm_lang$core$List$map,
								_elm_lang$core$List$reverse,
								_elm_community$list_extra$List_Extra$transpose(model.board));
					}
				}();
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{board: shifted, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ClearBoard':
				var board = A2(
					_elm_lang$core$List$map,
					_elm_lang$core$List$map(
						function (c) {
							return _user$project$Main$Dead;
						}),
					model.board);
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{board: board, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'MakeSoup':
				var _p29 = A2(_user$project$Main$makeSoup, model.seed, model.board);
				var seed = _p29._0;
				var board = _p29._1;
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{board: board, seed: seed, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SetWrap':
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{wrap: _p25._0, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Speed':
				var speed = A2(
					_elm_lang$core$Result$withDefault,
					0,
					_elm_lang$core$String$toInt(_p25._0));
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{speed: speed, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'BoardSize':
				var curdim = _elm_lang$core$List$length(model.board);
				var halfsize = A2(
					_elm_lang$core$Result$withDefault,
					(_user$project$Main$maxBoardSize / 2) | 0,
					_elm_lang$core$String$toInt(_p25._0));
				var boardsize = A2(_elm_lang$core$Basics$max, _user$project$Main$minBoardSize, 2 * halfsize);
				var board = A2(_user$project$Main$resizeBoard, boardsize, model.board);
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{board: board, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Trim':
				var cells = _user$project$Main$trimBoard(model.board);
				var w = _elm_lang$core$List$length(
					A2(
						_elm_lang$core$Maybe$withDefault,
						{ctor: '[]'},
			...
			case 'BoardLocation':
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{boardLocation: _p25._0, painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ImportBoard':
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{importedBoard: _p25._0});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ProcessImport':
				var _p30 = _user$project$Main$loadBoard(model.importedBoard);
				var headers = _p30._0;
				var board = _p30._1;
				var result = _elm_lang$core$Native_Utils.update(
					model,
					{board: board, headers: headers, mode: _user$project$Main$Playing, importedBoard: '', painting: false});
				return {ctor: '_Tuple2', _0: result, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var pattern = A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					_elm_lang$core$List$head(
						A2(_elm_lang$core$List$drop, _p25._0, _user$project$Main$builtinBoards)));
				var _p31 = _user$project$Main$loadBoard(pattern);
				var headers = _p31._0;
				var board = _p31._1;
				var result = _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$Clockwise = {ctor: 'Clockwise'};
...
var _user$project$Main$Trim = {ctor: 'Trim'};
var _user$project$Main$MakeSoup = {ctor: 'MakeSoup'};
var _user$project$Main$ClearBoard = {ctor: 'ClearBoard'};
var _user$project$Main$Shift = function (a) {
	return {ctor: 'Shift', _0: a};
};
var _user$project$Main$SetPattern = function (a) {
	return {ctor: 'SetPattern', _0: a};
};
var _user$project$Main$patternRow = F2(
	function (index, pattern) {
		var _p32 = _user$project$Main$patternInfo(pattern);
		var name = _p32._0;
		var author = _p32._1;
		var description = _p32._2;
		var url = _p32._3;
		return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Native_Utils.eq(author, '') ? _elm_lang$html$Html$text('') : A2(
										_elm_lang$html$Html$span,
										{ctor: '[]'},
										{
											ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Native_Utils.eq(url, '') ? _elm_lang$html$Html$text('') : A2(
													_elm_lang$html$Html$span,
													{ctor: '[]'},
													{
														ctor: '::',
														...
														_1: {
															...
															_0: A2(
																...
																A2(_elm_lang$core$Basics_ops['++'], 'http', url),
																'More Info…'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text(')'),
								...
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Main$SetPattern(index)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$title(
												A2(_elm_lang$core$Basics_ops['++'], 'Load ', name)),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Main$ProcessImport = {ctor: 'ProcessImport'};
var _user$project$Main$ImportBoard = function (a) {
	return {ctor: 'ImportBoard', _0: a};
};
var _user$project$Main$SetInputMode = function (a) {
	return {ctor: 'SetInputMode', _0: a};
};
var _user$project$Main$SetMode = function (a) {
	return {ctor: 'SetMode', _0: a};
};
var _user$project$Main$miscControls = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col-xs-12 text-center center-block btn-toolbar btn-toolbar-centered'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Main$SetMode(_user$project$Main$Import)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$title('Import from .CELL or .RLE notation…'),
													_1: {ctor: '[]'}
												}
											}
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-import'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Main$SetMode(_user$project$Main$Export)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$title('Export in .CELL notation…'),
														_1: {ctor: '[]'}
													}
												}
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-export'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {ctor: '[]'}
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Main$SetMode(_user$project$Main$Patterns)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$title('List of interesting patterns…'),
															_1: {ctor: '[]'}
														}
													}
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-list'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Main$SetMode(_user$project$Main$About)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$title('About this app…'),
																_1: {ctor: '[]'}
															}
														}
													},
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-xs-12 text-center center-block'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: A2(_user$project$Main$link, 'http://elm-lang.org/', 'Elm'),
												_1: {ctor: '[]'}
											}
										}
									}),
...
var _user$project$Main$importExport = F5(
	function (msg, footer, readonly, caption, contents) {
		var textAttributes = {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$Main_ops['=>'], 'display', 'block'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main_ops['=>'], 'margin-left', 'auto'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main_ops['=>'], 'margin-right', 'auto'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main_ops['=>'], 'font-family', 'courier,monospace'),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$readonly(readonly),
				_1: {
					ctor: '::',
		...
		return _elm_lang$core$Maybe$Just(
			{
				closeMessage: _elm_lang$core$Maybe$Just(
					_user$project$Main$SetMode(_user$project$Main$Playing)),
				containerClass: _elm_lang$core$Maybe$Just('elm-dialog'),
						...
						function () {
							...
							if (_p33.ctor === 'Just') {
								return A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_p33._0),
										_1: {ctor: '[]'}
									},
									textAttributes);
							} else {
...
var _user$project$Main$aboutUs = _elm_lang$core$Maybe$Just(
	{
		closeMessage: _elm_lang$core$Maybe$Just(
			_user$project$Main$SetMode(_user$project$Main$Playing)),
		containerClass: _elm_lang$core$Maybe$Just('elm-dialog'),
			...
			A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('The Rules of Life:'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Any live cell with fewer than two live neighbours dies, as if caused by underpopulation.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Any live cell with two or three live neighbours lives on to the next generation.'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Any live cell with more than three live neighbours dies, as if by overpopulation.'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Any dead cell with exactly three live neighbours becomes a live cell, as if by reproduction.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Useful Tips:'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('The white slider changes how fast new generations are computed; if it is all the way to the left, then it single-steps.'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('You can choose whether the edges of the board wrap around ( '),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$span,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-transfer'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html$text(' ) or the board can expand to fit the pattern ( '),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$span,
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-fullscreen'),
																		_1: {ctor: '[]'}
																	},
																	{ctor: '[]'}),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(' ). Just click the button to toggle.'),
																	_1: {ctor: '[]'}
																}
															}
														}
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('You may use either Tablet ( '),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$span,
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-hand-up'),
																	_1: {ctor: '[]'}
																},
																{ctor: '[]'}),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text(' ) or Mouse ( '),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$span,
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(' ) input mode. In Mouse-mode, you can hold the mouse button down and move the mouse to '),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('set or clear multiple cells. In Tablet-mode, each tap or click toggles a single cell.'),
																			_1: {ctor: '[]'}
																		}
																	}
																}
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('The grey slider changes the size of the board. '),
															_1: {
																ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('You can import ( '),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$span,
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(' ) and export ( '),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_elm_lang$html$Html$span,
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html$text(' ) patterns in .CELL or .RLE format. A good source for patterns is the '),
																				_1: {
																					ctor: '::',
																					_0: A2(_user$project$Main$link, 'http://www.conwaylife.com/wiki/Main_Page', 'Life Wiki'),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('. You can also choose some interesting patterns by clicking on '),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								_elm_lang$html$Html$span,
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Click on '),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_elm_lang$html$Html$span,
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Explore History'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(' to open Elm\'s time-travelling debugger. You can rewind the application to any prior state!'),
																			_1: {ctor: '[]'}
																		}
																	}
																}),
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('Implemented in '),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Main$link, 'http://elm-lang.org', 'Elm'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' by Robert Woodhead ('),
												_1: {
													ctor: '::',
													_0: A2(_user$project$Main$link, 'mailto:trebor@animeigo.com?Subject=Life-in-Elm', 'trebor@animeigo.com'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(')'),
														_1: {ctor: '[]'}
...
var _user$project$Main$patternsList = _elm_lang$core$Maybe$Just(
	{
		closeMessage: _elm_lang$core$Maybe$Just(
			_user$project$Main$SetMode(_user$project$Main$Playing)),
		containerClass: _elm_lang$core$Maybe$Just('elm-dialog'),
		header: _elm_lang$core$Maybe$Just(
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Interesting Life Patterns'),
					_1: {ctor: '[]'}
				})),
		body: _elm_lang$core$Maybe$Just(
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('pre-scrollable'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{ctor: '[]'},
								A2(_elm_lang$core$List$indexedMap, _user$project$Main$patternRow, _user$project$Main$builtinBoards)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				})),
...
var _user$project$Main$dialogsView = function (model) {
	return _krisajenkins$elm_dialog$Dialog$view(
		function () {
			...
			switch (_p34.ctor) {
				case 'Import':
					return A5(
						_user$project$Main$importExport,
						_elm_lang$core$Maybe$Just(_user$project$Main$ImportBoard),
						_elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ProcessImport),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$title('Import the board'),
											_1: {ctor: '[]'}
										}
									}
								},
				...
				case 'Export':
					return A5(
						...
						A2(
							...
							_user$project$Main$exportHeader,
							_user$project$Main$boardToStr(
								_user$project$Main$trimBoard(model.board))));
				case 'About':
					return _user$project$Main$aboutUs;
				case 'Patterns':
					return _user$project$Main$patternsList;
				default:
					return _elm_lang$core$Maybe$Nothing;
			}
		}());
};
var _user$project$Main$BoardSize = function (a) {
	return {ctor: 'BoardSize', _0: a};
};
var _user$project$Main$editingControls = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Main$Shift(_user$project$Main$Up)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$title('Shift Up'),
													_1: {ctor: '[]'}
												}
											}
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-arrow-up'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Main$Shift(_user$project$Main$Down)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$title('Shift Down'),
														_1: {ctor: '[]'}
													}
												}
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-arrow-down'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {ctor: '[]'}
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Main$Shift(_user$project$Main$Left)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$title('Shift Left'),
															_1: {ctor: '[]'}
														}
													}
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-arrow-left'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Main$Shift(_user$project$Main$Right)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$title('Shift Right'),
																_1: {ctor: '[]'}
															}
														}
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-arrow-right'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	_user$project$Main$Shift(_user$project$Main$Clockwise)),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$title('Rotate Clockwise'),
																	_1: {ctor: '[]'}
																}
															}
														},
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-xs-12 text-center center-block greyslider'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: A5(
										_user$project$Main$slider,
										_user$project$Main$BoardSize,
										'Slide to zoom board (in <-> out)',
										(_user$project$Main$minBoardSize / 2) | 0,
										(_user$project$Main$maxBoardSize / 2) | 0,
										(_elm_lang$core$List$length(model.board) / 2) | 0),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$Speed = function (a) {
	return {ctor: 'Speed', _0: a};
};
var _user$project$Main$SetWrap = function (a) {
	return {ctor: 'SetWrap', _0: a};
};
var _user$project$Main$BoardLocation = function (a) {
	return {ctor: 'BoardLocation', _0: a};
};
...
var _user$project$Main$boardView = function (model) {
	...
	var attrs = {
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$cursor(ctype),
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: A2(_user$project$Main_ops['=>'], 'background-color', 'lightgrey'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						_elm_lang$core$Native_Utils.eq(model.inputMode, _user$project$Main$UsingTouch) ? A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
								_0: _user$project$Main$mouseClick(_user$project$Main$MouseDown),
								_1: {ctor: '[]'}
							},
							attrs) : attrs,
						A2(_user$project$Main$boardSvg, cellsize, model.board)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$ToggleRun = {ctor: 'ToggleRun'};
var _user$project$Main$runningControls = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(
												model.running ? 'btn btn-danger' : 'btn btn-primary'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ToggleRun),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												model.running ? 'Stop' : (_elm_lang$core$Native_Utils.eq(model.speed, 0) ? 'Step' : 'Run')),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: model.wrap ? A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$title('Edges of the board wrap around'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Main$SetWrap(false)),
														_1: {ctor: '[]'}
													}
												}
											},
											...
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$title('Edges of the board expand as needed'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Main$SetWrap(true)),
														_1: {ctor: '[]'}
													}
												}
											},
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Native_Utils.eq(model.inputMode, _user$project$Main$UsingMouse) ? A2(
												_elm_lang$html$Html$button,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('btn btn-default'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$title('Using a mouse; click, hold and move to change the board'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Main$SetInputMode(_user$project$Main$UsingTouch)),
															_1: {ctor: '[]'}
														}
													}
												},
												...
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$title('On a tablet; click to toggle cells'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_user$project$Main$SetInputMode(_user$project$Main$UsingMouse)),
															_1: {ctor: '[]'}
														}
													}
												},
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_1: {
									ctor: '::',
									_0: A5(_user$project$Main$slider, _user$project$Main$Speed, 'Slide to change generation speed (step, slower <-> faster)', 0, 20, model.speed),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$controlsView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Main$runningControls(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$editingControls(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$miscControls(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$boardView(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$controlsView(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$dialogsView(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$boardLocation(_user$project$Main$BoardLocation),
			_1: {
				ctor: '::',
				_0: (model.running && (_elm_lang$core$Native_Utils.cmp(model.speed, 0) > 0)) ? A2(
					_elm_lang$core$Time$every,
					_elm_lang$core$Time$second / _elm_lang$core$Basics$toFloat(model.speed),
					_user$project$Main$Tick) : _elm_lang$core$Platform_Sub$none,
				_1: {
					ctor: '::',
					_0: (_elm_lang$core$Native_Utils.eq(model.inputMode, _user$project$Main$UsingMouse) && _elm_lang$core$Native_Utils.eq(model.mode, _user$project$Main$Playing)) ? (model.painting ? _elm_lang$core$Platform_Sub$batch(
						{
							ctor: '::',
						...
						}) : _elm_lang$mouse$Mouse$downs(_user$project$Main$MouseDown)) : _elm_lang$core$Platform_Sub$none,
					_1: {ctor: '[]'}
				}
			}
		});
	...
	A2(
		...
		function (hasTouch) {
			return A2(
				...
				function (randomSeed) {
					return _elm_lang$core$Json_Decode$succeed(
						{hasTouch: hasTouch, randomSeed: randomSeed});
				},
				A2(_elm_lang$core$Json_Decode$field, 'randomSeed', _elm_lang$core$Json_Decode$float));
		},
		A2(_elm_lang$core$Json_Decode$field, 'hasTouch', _elm_lang$core$Json_Decode$bool)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.InputMode":{"args":[],"tags":{"UsingTouch":[],"UsingMouse":[]}},"Main.Msg":{"args":[],"tags":{"MouseUp":["Mouse.Position"],"SetPattern":["Int"],"Trim":[],"Tick":["Time.Time"],"Shift":["Main.Direction"],"MakeSoup":[],"ClearBoard":[],"MouseDown":["Mouse.Position"],"ToggleRun":[],"SetWrap":["Bool"],"ProcessImport":[],"SetMode":["Main.Mode"],"ImportBoard":["String"],"SetInputMode":["Main.InputMode"],"BoardSize":["String"],"BoardLocation":["Main.ObjectLocation"],"Speed":["String"],"MouseMove":["Mouse.Position"]}},"Main.Direction":{"args":[],"tags":{"Down":[],"Up":[],"Left":[],"Clockwise":[],"Right":[]}},"Main.Mode":{"args":[],"tags":{"Export":[],"Playing":[],"About":[],"Import":[],"Patterns":[]}}},"aliases":{"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Main.ObjectLocation":{"args":[],"type":"{ top : Int, left : Int, width : Int, height : Int }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
